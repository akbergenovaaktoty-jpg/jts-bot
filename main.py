...
CURATORS = {
    "Айдана": {"id": 699436618, "username": "@Aidana_seitpeshova"},
    "Нурай": {"id": 683139471, "username": "@nuray_ik"},
    "Томирис": {"id": 862482306, "username": "@Tomiris_Kaken"},
}
...
async def button_handler(update, context):
    ...
    if query.data.startswith("curator_"):
        ...
        await query.edit_message_text(
            f"Ваш куратор: {name}\n\nТеперь заполните анкету - скопируйте, вставьте свои данные и отправьте:\n\n" + ANKETA
        )
